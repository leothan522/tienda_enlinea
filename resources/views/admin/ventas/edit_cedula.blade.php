...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            {!! Form::open(['route' => ['ventas.cedula.update', $datos->id], 'method' => 'PUT']) !!}
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('nombre_completo', $datos->nombre_completo, ['class' => 'form-control',
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('telefono', $datos->telefono, ['class' => 'form-control',
                                                    'placeholder' => 'Numero', 'data-inputmask' => '"mask": "(9999) 999-99.99"',
                                                    'data-mask', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group">
