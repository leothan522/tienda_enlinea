            ...
            <div class="card card-widget widget-user-2">
                ...
                <div class="card-footer p-0">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item nav-link">
                            <span class="text-bold text-muted">Monto:</span>
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if($compra->referencia != null && $compra->factura != null && $compra->estatus != "Despachado")
                            <a href="{{ route('ventas.despacho.update', $compra->id) }}" class="btn btn-tool btn-sm" title="Despachado" onclick="return confirm('Se Despacho la Factura: {{ $compra->factura }}')">
