...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('clientes.create') }}">Agregar Cliente</a></li>
@endsection
...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header bg-maroon border-0">
                    <h3 class="card-title">Clientes Registrados - <span class="text-bold">({{ $total }})</span></h3>
                            ...
                            @foreach($compras as $compra)
                                ...
                                <tr class="text-center table-primary text-sm">
                                    <td class="text-center">
                                        <span class="badge">{{ $compra->cedula }}</span>
                                    </td>
                                    <td class="text-left small">{{ $compra->nombre_completo }}</td>
